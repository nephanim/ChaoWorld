...
(
    ...
    swimfactor double precision not null default 0.10,
    flyfactor double precision not null default 0.10,
    runfactor double precision not null default 0.10,
    powerfactor double precision not null default 0.10,
    staminafactor double precision not null default 0.10,
    intelligencefactor double precision not null default 0.10,
    luckfactor double precision not null default 0.10,
