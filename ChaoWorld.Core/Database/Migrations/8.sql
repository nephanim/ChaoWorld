...
values
	...
	(2, 'Sprout', 'Small-scale tournament with two rounds', 2, 2, true, 1, 4, 200),
	(3, 'Disciple', 'Typical-scale tournament with three rounds', 3, 3, true, 1, 8, 400),
	(4, 'Master', 'Large-scale tournament with four rounds', 4, 4, true, 1, 16, 800),
	(5, 'Grandmaster', 'Massive-scale tournament with five rounds', 5, 5, true, 1, 32, 1600);
