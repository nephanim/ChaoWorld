...
namespace ChaoWorld.Bot
{
    public class Autoproxy
    {
        ...
        private async Task AutoproxyMember(Context ctx, Chao member)
        {
        ...
        private async Task UpdateAutoproxy(Context ctx, AutoproxyMode autoproxyMode, ChaoId? autoproxyMember)
        {
