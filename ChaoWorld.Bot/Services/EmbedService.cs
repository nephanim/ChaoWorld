...
namespace ChaoWorld.Bot
{
    public class EmbedService
    {
        ...
        public Embed CreateLoggedMessageEmbed(Message triggerMessage, Message proxiedMessage, string systemId, Core.Chao chao, string channelName, string oldContent = null)
        {
            ...
            var embed = new EmbedBuilder()
                ...
                .Footer(new($"Garden ID: {systemId} | Chao ID: {chao.Id} | Sender: {triggerMessage.Author.Username}#{triggerMessage.Author.Discriminator} ({triggerMessage.Author.Id}) | Message ID: {proxiedMessage.Id} | Original Message ID: {triggerMessage.Id}"))
